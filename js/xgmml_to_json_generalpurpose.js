...
class NodeLine(object):
    ...
    def __init__(self, xline):
        ...
        self.nodeline = {"data" : {"id": self.cid, "name": self.name, "faveColor": self.faveColor : self.node_type},  "position": {"x": self.x, "y": self.y}}
...
main("CytoscapeSession-2013_07_01-17_20//Sheet1.xgmml", "../generalpurpose_network.json")
